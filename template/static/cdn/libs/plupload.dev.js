...
plupload.addFileFilter('mime_types', function(filters, file, cb) {
	if (filters.length && filters.regexp && !filters.regexp.test(file.name)) {
		this.trigger('Error', {
...
plupload.Uploader = function(options) {
	...
	function setOption(option, value, init) {
		...
		function _setOption(option, value, init) {
          ...
          if (value.mime_types && typeof(value.mime_types) !== 'string') {
						settings.filters.mime_types.regexp = (function(filters) {
							var extensionsRegExp = [];

							plupload.each(filters, function(filter) {
								console.log("filter.extensions" + filter.extensions);
	...
	plupload.extend(this, {
		...
		addFile : function(file, fileName) {
			...
			, ruid
			;
			var selectedFileCount = this.total.uploaded + this.total.queued + file.length;
			if(this.settings.exceedCountLimit){
				if(this.settings.exceedCountLimit(selectedFileCount)) {
					return;
				}
            }
		...
		removeFile : function(file) {
			...
			this.total.uploaded -= file.length;
		},
