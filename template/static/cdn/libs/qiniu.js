...
function QiniuJsSDK() {
    ...
    this.uploader = function(op) {
        ...
        console.log("bind FilesAdded event");
        ...
        uploader.bind('BeforeUpload', function(up, file) {
            ...
            var directUpload = function(up, file, func) {
                ...
                if (ie && ie <= 9) {
                    ...
                    console.log("add accept text/plain in multipart params");
                }

                console.log("directUpload multipart_params_obj: ", multipart_params_obj);
            ...
            console.log("uploader.runtime: ",uploader.runtime);
            ...
            if ((uploader.runtime === 'html5' || uploader.runtime === 'flash') && chunk_size) {
                ...
                console.log("directUpload because uploader.runtime !== 'html5' || uploader.runtime !== 'flash' || !chunk_size");
                // direct upload if runtime is not html5
                directUpload(up, file, that.key_handler);
            }
        });

        console.log("bind BeforeUpload event");
        ...
        uploader.bind('ChunkUploaded', function(up, file, info) {
            ...
            if (leftSize < chunk_size) {
                ...
                console.log("up.setOption url: ", qiniuUploadUrl + '/mkblk/' + leftSize);
            }
            up.setOption({
                'headers': {
                    'Authorization': 'UpToken ' + getUptoken(file)
        ...
        console.log("bind ChunkUploaded event");
        ...
        uploader.bind('FileUploaded', (function(_FileUploaded_Handler) {
            return function(up, file, info) {
                console.log("FileUploaded event activated");
                console.log("file: ", file);
                console.log("info: ", info);
                ...
                if (ctx) {
                    var key = '';
                    console.log("save_key: ", op.save_key);
                    if (!op.save_key) {
                    ...
                    console.log("op.x_vars: ", op.x_vars);
                    var x_vars = op.x_vars,
                        x_val = '',
                        x_vars_url = '';
                    if (x_vars !== undefined && typeof x_vars === 'object') {
                    ...
                    var onreadystatechange = function(){
                        ...
                        if (ajax.readyState === 4) {
                            ...
                            if (ajax.status === 200) {
                                ...
                                console.log("mkfile is success: ", info);
                                ...
                                console.log("mkfile is error: ", info);
        ...
        console.log("bind FileUploaded event");

        // init uploader
        uploader.init();

        console.log("invoke uploader.init()");

        console.log("init uploader end");
